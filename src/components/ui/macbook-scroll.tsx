...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[120vh]  flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      {/* <motion.h2
        style={{
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
...
export const Trackpad = () => {
  return (
    <div
      className="w-[40%] mx-auto h-32  rounded-xl my-1 bg-black"
      style={{
